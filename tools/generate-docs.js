...
var tree = require('metamagical-static-tree');

var root = path.join(__dirname, '../documentation');
...
var Refinable = require('../');
generateTree(tree(metamagical, 'refinable', Refinable, {
  skip: new Set([Refinable.toString.prototype, Refinable.refine.prototype])
}));
